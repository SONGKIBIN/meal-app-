  ...
  sections: [
    {
      ...
      children: [
        ...
        ...bullets([
          ...
          "만족도 조사 탭(신규, 관리자 전용): 식사를 신청한 직원이 중식 12:00~13:00 / 석식 17:00~18:00 사이에 남긴 별점(1~5개, 20~100점 환산)과 이유를 부서별로 집계해서 볼 수 있습니다. '일별'/'월간' 보기를 전환할 수 있고, 부서별 응답인원·평균점수·별점 분포와 개별 응답(이유 포함) 목록을 확인하며 엑셀 다운로드·인쇄가 가능합니다.",
        ]),
        h2("식사 만족도 별점 평가 (신규)"),
        ...bullets([
          "식사를 신청한 직원은 중식 12:00~13:00 / 석식 17:00~18:00 사이에만 '내 식사 신청' 화면 위쪽에 평가 카드가 나타나고, 별 1~5개(20~100점 환산)와 이유(사유, 필수 입력)를 남길 수 있습니다. 신청하지 않았거나 시간대가 아니면 카드가 보이지 않습니다.",
          "평가 시간대 안에서는 다시 눌러 별점·이유를 수정할 수 있습니다.",

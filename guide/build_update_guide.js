  ...
  sections: [
    {
      ...
      children: [
        ...
        ...bullets([
          ...
          "만족도 조사 탭(신규, 관리자 전용): 식사를 신청한 직원이 중식 12:00~15:00 / 석식 17:00~20:00 사이에 남긴 별점(1~5개, 20~100점 환산)과 이유를 부서별로 집계해서 볼 수 있습니다. '일별'/'월간' 보기를 전환할 수 있고, 부서별 응답인원·평균점수·별점 분포와 개별 응답(이유 포함) 목록을 확인하며 엑셀 다운로드·인쇄가 가능합니다.",
        ]),
        h2("식사 만족도 별점 평가 (신규)"),
        ...bullets([
          "'내 식사 신청' 화면 위쪽에 평가 카드가 항상 표시됩니다. 다만 실제로 별점을 등록하려면 그 끼니를 신청한 상태로 중식 12:00~15:00 / 석식 17:00~20:00 사이여야 하며, 그 외에는 입력칸이 비활성화되고 '○○을 신청하면 평가할 수 있습니다' 또는 '평가 가능 시간: OO:OO ~ OO:OO' 안내 문구가 표시됩니다.",

  ...
  sections: [
    {
      ...
      children: [
        ...
        ...bullets([
          "직원 관리 탭에서 특정 직원을 수정할 때 '권한'을 '운영자'로 바꾸면, 바로 아래 '담당 부서' 입력칸이 나타납니다. 그 직원의 소속 부서는 자동으로 포함되고, 여기에 추가로 관리하게 하고 싶은 부서명을 쉼표(,)로 구분해서 입력한 뒤 저장하면 됩니다 (예: 생산1팀, 생산2팀).",
          "담당 부서를 입력할 때 기존에 등록된 부서명이 자동완성 목록으로 함께 표시되니, 목록에서 골라 입력하면 오타로 부서명이 어긋나는 것을 방지할 수 있습니다.",
